...
data_customer_segmentation <-data_customer %>%
                              ...
                              summarise(count_orders = n(), max_purchase = max(order_purchase_timestamp)) %>%
                              select(customer_unique_id, count_orders, max_purchase)
...
```{r}
customer_segmentation_num <- data_customer_segmentation[,4]
