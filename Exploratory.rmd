...
data_customer$delivered_weekday <- weekdays(data_customer$order_purchase_timestamp)
```
...
ggplot(data_customer, aes(x = purchase_weekday, fill = purchase_weekday)) +
  ...
  geom_hline(yintercept = mean(orders_per_weekday$number_of_orders), linetype = "dashed", color = "black") +
  geom_text(aes(x = 4, y = mean(orders_per_weekday$number_of_orders)+400, label = "Mean"), color = "black", fontface = "bold")
```
